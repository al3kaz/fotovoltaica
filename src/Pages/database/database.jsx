         ...
         <div className="d-flex flex-column bd-highlight m-3">
            <ul className="nav nav-pills">
               <li className="nav-item">
                  <NavLink className="nav-link" to={`${url}/modules`}>Moduły</NavLink>
               </li>
               <li className="nav-item">
                  <NavLink className="nav-link" to={`${url}/inverters`}>Falowniki</NavLink>
               </li>
               <li className="nav-item">
                  <NavLink className="nav-link" to={`${url}/constructions`}>Konstrukcja</NavLink>
               </li>
               <li className="nav-item">
                  <NavLink className="nav-link" to={`${url}/installation`}>Montaż (Cennik)</NavLink>
               </li>
               <li className="nav-item">
                  <NavLink className="nav-link" to={`${url}/ppoz`}>Zabezpieczenie PPOŻ</NavLink>
               </li>
               <li className="nav-item">
                  <NavLink className="nav-link" to={`${url}/ac/dc`}>Zabezpieczenie AC/DC</NavLink>
               </li>
            </ul>
         </div>
